...
class CourseOrg(models.Model):
    ...
    city=models.ForeignKey(CityDict,verbose_name='所在城市',on_delete=models.CASCADE)  #引用外键的时候，外键中所指向的类必须在之前定义
    add_time=models.DateTimeField(default=datetime.now)
    catgory=models.CharField(max_length=20,choices=ORG_CHOICES,verbose_name="机构类别",default="pxjg")
    tag=models.CharField('机构标签',max_length=10,default='全球知名')
