...
class OrgView(View):
    ...
    def get(self,request):
        ...
        #课程点击量排序
        host_orgs = all_orgs.order_by('-click_nums')[:2]
...
#     serialize()过序列化表单值创建URL编码文本字符串。
# 您可以选择一个或多个表单元素（如输入和 / 或文本区），或表单元素本身。序列化的值可在生成AJAX请求时用于URL查询字符串中。
#
